...
When creating a category, you can specify whether it is an `income` or `expense` category. This is used to determine how transactions in that category contribute to your budgets and financial metrics.
