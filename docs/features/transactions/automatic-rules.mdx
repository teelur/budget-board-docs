...
To manage your automatic rules, navigate to the `Transaction Settings` page by clicking the gear icon on the top right of the `Transactions` page. Automatic rules are found under the `Automatic Rules` section.
