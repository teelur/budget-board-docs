...
A goal can be configured with either a specific target date or a monthly contribution target. When you specify one, the other will be calculated automatically based on your current progress.
