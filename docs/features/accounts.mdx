...
If you want to hide the transactions for an account from the transactions list, you can enable this option. This is useful for accounts that you don't want to see in your transaction list or include in your spending metrics, such as a loan. The outflows for this loan will be captured from other accounts (e.g., your checking account), so including the transactions from the loan account would double count your spending.
