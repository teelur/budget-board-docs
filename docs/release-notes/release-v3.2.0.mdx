...
See the [Auto-Categorization page](../features/transactions/auto-categorization) in the wiki for more details on how to use this feature and how it works under the hood.
