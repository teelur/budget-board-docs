...
You can now export your transactions to a CSV file for use in other applications. Click on the `Export` button on the Transactions page to open the new dialog, where you can apply filters as well as select and rearrage the columns to include in the export.
