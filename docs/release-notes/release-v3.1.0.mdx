...
Currently, Budget Board only includes US English translations. However, we welcome contributions for additional languages. If you're interested in helping with translations, please check out our [localization guide](TODO) in the wiki.
...
{/* TODO: Add pics of net worth card customization */}
...
{/* TODO: Dark mode screenshots comparing old to new. */}
...
{/* TODO: Light mode screenshots comparing old to new. */}
