...
![Bulk Edit Transactions](/img/release-template/v3.5.0/bulk-edit-transactions.png)
...
![New Login Interface](/img/release-template/v3.5.0/new-login-interface.png)
...
![Spending by Category Graph](/img/release-template/v3.5.0/new-spending-by-category-graph.png)
...
![New Settings Page](/img/release-template/v3.5.0/new-settings-page.png)
