...
| Option            | Details                                                                                                           |
| ----------------- | ----------------------------------------------------------------------------------------------------------------- |
| `VITE_API_URL`    | This is the URL you use to access Budget Board. (e.g. `localhost:6253` or `budget-board.example.com`)             |
| `VITE_SERVER_URL` | This is the address of your `budget-board-server` container. You shouldn't need to set this environment variable. |
