...
| `SERVER_ADDRESS`      | This is the address of your `budget-board-server` container. You should not need to modify this environment variable. |
...
| Option           | Details                                                                                                               |
| ---------------- | --------------------------------------------------------------------------------------------------------------------- |
| `CLIENT_ADDRESS` | This is the address of your `budget-board-client` container. You should not need to modify this environment variable. |
