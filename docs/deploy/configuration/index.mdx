...
| `TZ`                | The timezone for the database (e.g. `America/New_York`). See the [list of valid timezone values](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones). If not set, defaults to UTC timezone. |
